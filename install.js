...
function main() {
  ...
  log('  /lsearch <query>     - Search knowledge base', Colors.cyan);
  log('  /lsearch-index       - Index documents', Colors.cyan);
  log('  /lsearch-fetch <url> - Fetch and index URL', Colors.cyan);
  log('  /lsearch-add <path>  - Add path to knowledge base', Colors.cyan);
  log('  /lsearch-stats       - Show statistics', Colors.cyan);
  log('  /kb <query>          - Force search knowledge base', Colors.cyan);
  log('\nQuick start:', Colors.bright);
  log('  1. In your project, run: /lsearch-init', Colors.yellow);
  log('  2. Then index docs: /lsearch-index', Colors.yellow);
