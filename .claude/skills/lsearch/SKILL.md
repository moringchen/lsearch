...
**Trigger Keywords:**
- Documentation-related: "docs", "documentation", "文档"
- Architecture-related: "architecture", "设计", "架构"
- API-related: "api", "interface", "接口"
- Deployment-related: "deploy", "deployment", "部署"
- Configuration-related: "config", "configuration", "配置"
- Process-related: "how to", "流程", "怎么", "如何"

**Examples of auto-trigger:**
- "What's the deployment process?" → Auto-search
- "怎么配置数据库？" → Auto-search
- "API documentation" → Auto-search
- "项目架构是什么样的？" → Auto-search
